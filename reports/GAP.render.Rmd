...
```{r}
performance_profile(results[results$solver_with_params %in% c("external", "idol_bab_h1", "idol_bap_h1_s0_f0_c1500_m1", "coluna"),], xlim = c(1, 200), main = "External solver, Coluna, BaB and BaP")
```

...
```{r}
results[,c("instance", "solver_with_params", "time")]
...
```{r}
performance_profile(results[results$solver_with_params %in% c("external_solver", "idol_bab_h1", "idol_bap_h1_s30_f0_c500_m1", "coluna"),], xlim = c(1, 200), main = "External solver, BaB and BaP")
```
